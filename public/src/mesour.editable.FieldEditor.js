...
(function($) {
	...
	mesour._editable.FieldEditor = function(editable, fieldStructure, element, identifier, value) {
		...
		if (type === editable.TYPE_TEXT) {
			...
			field = new mesour._editable.fields.Date(fieldStructure, editable, element, parameters, identifier);
