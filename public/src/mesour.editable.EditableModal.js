...
(function ($) {
    ...
    mesour._editable.EditableModal = function (name, editable) {
        ...
        function createForm(dataStructure) {
            ...
            for (var i in dataStructure) {
                ...
                if (structure['type'] === editable.TYPE_TEXT) {
                    var field = addTextField(addFormGroup(), name + structure['name'], structure['title'], structure['name'], structure['title']);
            ...
            var refreshCallback = function (e) {
                ...
                for (var i in values) {
                    ...
                    if (
                        ...
                        && !mesour._editable.Validators.validateNumber(editable, values[i], input)
                    ) {
                        valid = false;
                    }
                }
        ...
        this.addHiddenField = function (form, name, value) {
        ...
        this.getFormValues = function (form) {
            var values = {};
            form.find('input[type=text], select, [data-editable-in-data]').each(function () {
                var $this = $(this);
        ...
        this.fillForm = function (form, values, hidden) {
            for (var _key in values) {
                ...
                var input = form.find('input[name="' + _key + '"], select[name="' + _key + '"]');
                if (input.is('*')) {
