...
class ManyToOneEditCurrentEditTest extends BaseTestCase
{
	...
	public function testDefault()
	{
		...
		$application = $this->createApplication('editableTest-editForm', $request);
...
$test = new ManyToOneEditCurrentEditTest();
$test->run();
